...
"""
    ...
    author: budiman pardede
    author: instagram @nggaktau285 (apaitu285@gmail.com)
    author: facebook (ariftau285@gmail.com)

    Thanks sudah ikut kontribusinya pada proyek ini.
    jika kamu butuh bantuan dan ingin namamu dicantukman di script saya
    ...
    English bahasa / Security additions english
    -----------------
...
def banner(RUN_CONFIG):
    ...
    print ''
    print G + "  .;'                     `;,    "
    print G + " .;'  ,;'             `;,  `;,   " + W + "wifi bud1man (r" + str(RUN_CONFIG.REVISION) + ")"
    print G + ".;'  ,;'  ,;'     `;,  `;,  `;,  "
    print G + "::   ::   :   " + GR + "(bud1man )" + G + "   :   ::   ::  " + GR + "automated wireless auditor"
    print G + "':.  ':.  ':. " + GR + "/_\\" + G + " ,:'  ,:'  ,:'  "
    print G + " ':.  ':.    " + GR + "/___\\" + G + "    ,:'  ,:'   " + G + "ini versi terbaru:"
    print G + "  ':.       " + GR + "/_____\\" + G + "      ,:'     " + C + "https://github.com/und3f1n3/"
    print G + "           " + GR + "/       \\" + G + "             "
    print W
...
def help():
    ...
    print sw + '\t-cracked    \t' + des + 'perlihatkan access points sebelunya yang telah di  crack' + W
    print sw + '\t-recrack    \t' + des + 'ijinkan sebelumnya recracking access points' + W
    print ''

    print head + '   GLOBAL' + W
    print sw + '\t-all         \t' + des + 'attack semua targets.              ' + de + '[off]' + W
    #print sw+'\t-pillage     \t'+des+'attack all targets in a looping fashion.'+de+'[off]'+W
    print sw + '\t-i ' + var + '<iface>  \t' + des + 'wireless interface untuk monitor ' + de + '[auto]' + W
    ...
    print sw + '\t-c ' + var + '<channel>\t' + des + 'target yang di scanning      ' + de + '[auto]' + W
    print sw + '\t-e ' + var + '<essid>  \t' + des + 'target a specific access point mengggunakan nama ssid (nama wifinya)  ' + de + '[ask]' + W
    print sw + '\t-b ' + var + '<bssid>  \t' + des + 'target a specific access point by bssid (mac addressnya)  ' + de + '[auto]' + W
    print sw + '\t-showb       \t' + des + 'perlihatkan target BSSIDs sesudah scanning               ' + de + '[off]' + W
    print sw + '\t-pow ' + var + '<db>   \t' + des + 'attacks beberapa targets dengan sinyal kuat > ' + var + 'db ' + de + '[0]' + W
    print sw + '\t-quiet       \t' + des + 'jangan ketik list dari APs ketika terjadi scan           ' + de + '[off]' + W
    print ''

    print head + '\n   WPA' + W
    print sw + '\t-wpa        \t' + des + 'hanya target WPA networks (works with -wps -wep)   ' + de + '[off]' + W
    print sw + '\t-wpat ' + var + '<sec>   \t' + des + 'waktu menunggu untuk menyerang WPA agar complete (seconds) ' + de + '[500]' + W
    print sw + '\t-wpadt ' + var + '<sec>  \t' + des + 'waktu utk menunggu between sending deauth packets (sec) ' + de + '[10]' + W
    ...
    print sw + '\t-dict ' + var + '<file>\t' + des + 'specifikasi kamus memakai ketika cracking WPA ' + de + '[phpbb.txt]' + W
    ...
    print head + '\n   WEP' + W
    print sw + '\t-wep        \t' + des + 'hanya target WEP networks ' + de + '[off]' + W
    print sw + '\t-pps ' + var + '<num>  \t' + des + 'atur nomor paket per detik buat inject ' + de + '[600]' + W
    print sw + '\t-wept ' + var + '<sec> \t' + des + 'sec to wait for each attack, 0 implies endless ' + de + '[600]' + W
    print sw + '\t-chopchop   \t' + des + 'pakai chopchop attack      ' + de + '[on]' + W
    print sw + '\t-arpreplay  \t' + des + 'pakai arpreplay attack     ' + de + '[on]' + W
    print sw + '\t-fragment   \t' + des + 'pakai fragmentation attack ' + de + '[on]' + W
    print sw + '\t-caffelatte \t' + des + 'pakai caffe-latte attack   ' + de + '[on]' + W
    print sw + '\t-p0841      \t' + des + 'pakai -p0841 attack        ' + de + '[on]' + W
    print sw + '\t-hirte      \t' + des + 'pakai hirte (cfrag) attack ' + de + '[on]' + W
    print sw + '\t-nofakeauth \t' + des + 'pakai attack jika fake authentication fails    ' + de + '[off]' + W
    print sw + '\t-wepca ' + GR + '<n>  \t' + des + 'mulai cracking ketika nomer dari ivs surpass n ' + de + '[10000]' + W
    print sw + '\t-wepsave    \t' + des + 'simpan sebuah copy dari file .cap ke penyimpanan ' + de + '[off]' + W

    print head + '\n   WPS' + W
    print sw + '\t-wps       \t' + des + 'hanya target WPS networks         ' + de + '[off]' + W
